...
if __name__ == '__main__':
    ...
    tkinter.messagebox.showinfo('question', 'If you find yourself having to cross a piranha-infested river, here\'s how to do it...')
    # tkinter.simpledialog.askstring('question', 'If you find yourself having to cross a piranha-infested river, here\'s how to it...')
    # Get the player to enter an adjective
    tkinter.simpledialog.askstring('answer', 'Enter an adjective')
    # Get the player to enter a type of liquid
    tkinter.simpledialog.askstring('answer', 'Enter a type of liquid')
    # Get the player to enter a body part
    tkinter.simpledialog.askstring('answer', 'Enter a body part')
    # Get the player to enter a verb
    tkinter.simpledialog.askstring('answer', 'Enter a verb')
    # Get the player to enter a place
    tkinter.simpledialog.askstring('answer', 'Enter a place')
    ...
    tkinter.simpledialog.askstring('story''"Piranhas are more muddy during the day, so cross the river at\n"'
        ...
        "you do, if you have an open wound, try to find another way to get "
        "back to the hospital. Good luck!"'')
